...
class VoiceAssistant:
    ...
    def start_listening(self):
        """Main listening loop"""
        self.speak("Voice assistant activated. Say 'hello' to start or 'exit' to quit.")
...
"""
Before running this voice assistant, install the required packages:
...
Note: If pyaudio installation fails on Windows, try:
   pip install pipwin
   pipwin install pyaudio

For weather functionality:
1. Sign up for a free API key at: https://openweathermap.org/api
2. Replace 'YOUR_API_KEY' in the get_weather method with your actual API key
